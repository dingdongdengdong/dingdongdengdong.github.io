...
`)+`
`+u);let C=R+m+o,A=R+u+a,L=jh(s,s.VERTEX_SHADER,C),P=jh(s,s.FRAGMENT_SHADER,A);s.attachShader(y,L),s.attachShader(y,P),e.index0AttributeName!==void 0?s.bindAttribLocation(y,0,e.index0AttributeName):e.morphTargets===!0&&s.bindAttribLocation(y,0,"position"),s.linkProgram(y);function U(I){if(i.debug.checkShaderErrors){let z=s.getProgramInfoLog(y).trim(),H=s.getShaderInfoLog(L).trim(),Y=s.getShaderInfoLog(P).trim(),tt=!0,B=!0;if(s.getProgramParameter(y,s.LINK_STATUS)===!1)if(tt=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(s,y,L,P);else{let rt=$h(s,L,"vertex"),X=$h(s,P,"fragment");console.error("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(y,s.VALIDATE_STATUS)+`
